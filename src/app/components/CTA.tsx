    ...
    <section className="w-full bg-[var(--brand)]">
      <div className="flex flex-col items-center justify-center py-16 lg:py-[100px] px-5 lg:px-[100px]">
        <div className="flex flex-col gap-8 lg:gap-12 items-center max-w-[858px] w-full">
          ...
          <div className="flex flex-col gap-4 lg:gap-6 items-center text-white font-[var(--font-manrope)] font-normal text-center max-w-full lg:max-w-[600px]">
            <p
              className="leading-[1] w-full m-0"
              style={{ fontSize: "clamp(32px, 6vw, 56px)", letterSpacing: "-1.64px" }}
            >
              Let's shape something valuable together.
            </p>
            <p className="text-sm lg:text-base leading-[1.5] font-light text-center max-w-full lg:max-w-[450px] m-0">
