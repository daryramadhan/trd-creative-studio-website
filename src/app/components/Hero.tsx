...
export function Hero() {
  return (
    <section
      className="relative w-full bg-[var(--dark)]"
      style={{ minHeight: "clamp(600px, 100dvh, 982px)" }}
    >
      <Navbar />

      {/* Main content */}
      <div className="flex flex-col items-center justify-end h-full px-5 lg:px-[100px] pt-[140px] lg:pt-[200px] pb-14 lg:pb-[100px] gap-10 lg:gap-14">
        {/* Badge */}
        <div className="flex gap-[10px] items-center justify-center px-4 py-2 rounded-full bg-[var(--brand-10)]">
          ...
          <span className="font-[var(--font-manrope)] font-light text-[var(--brand)] text-sm leading-[1.4] underline whitespace-nowrap">
            See Pricing
          </span>
        </div>

        {/* Headline block */}
        <div className="flex flex-col items-center gap-6 lg:gap-8 max-w-[800px] w-full text-center">
          <p
            className="font-[var(--font-manrope)] font-normal text-white m-0"
            style={{ fontSize: "clamp(36px, 7vw, 82px)", lineHeight: 1, letterSpacing: "-1.64px" }}
          >
            Turn complex ideas into clear digital products.
          </p>
          <p className="font-[var(--font-manrope)] font-light text-white text-sm lg:text-base leading-[1.5] max-w-[586px] m-0">
        ...
        <div className="flex flex-wrap gap-3 lg:gap-4 items-center justify-center">
          <button className="bg-[var(--brand)] text-white font-[var(--font-manrope)] font-light text-sm lg:text-base leading-[1.4] px-6 py-2 rounded-full border-none cursor-pointer whitespace-nowrap hover:opacity-90 transition-opacity">
            Start a Project
          </button>
